...
<details>
  ...
  <div class="faq__content">
    <p>Vous ne savez pas si le Dojo est l'endroit idéal pour vous et votre équipe ? Visitez notre page <a href="{{ site.data.i18n[page.lang].learn_url | default: site.data.i18n.en.learn_url }}" aria-label="{{ site.data.i18n[page.lang].learn | default: site.data.i18n.en.learn }}\">En savoir plus</a> où vous pourrez voir notre présentation du Dojo Digital qui décrit tout ce que vous devez savoir avant d'entrer dans le Dojo. Ou prenez un moment pour regarder notre vidéo Digital Dojo Experience qui explique le parcours d'une équipe à travers toutes les étapes du Dojo.</p>
